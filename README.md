...
<p align="center">
  <a href="https://www.npmjs.com/package/@xmatics/xsana"><img src="https://img.shields.io/npm/v/@xmatics/xsana" alt="npm version" /></a>
  <a href="https://github.com/x-matics/xsana/blob/main/LICENSE"><img src="https://img.shields.io/npm/l/@xmatics/xsana" alt="license" /></a>
</p>
...
This creates the project structure, installs dependencies (`asana` + `@xmatics/xsana`), and generates a config file.
...
import { log, tasksApiInstance, ... } from '@xmatics/xsana';
```
...
// ============================================================================
import { log, tasksApiInstance, project_gid, task_gid, workspace_gid } from '@xmatics/xsana';
...
- [xsana on npm](https://www.npmjs.com/package/@xmatics/xsana)
